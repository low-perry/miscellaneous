...
title: Luigi's Box Magento 2 Integration Guide
---
...
{{ callout('warning', 'Having **Bot Fight Mode** enabled will make communication with Luigi\'s Box servers impossible. The integration will not work with Bot Fight Mode active.') }}
...
This allows Luigi's Box to access your store's API endpoints while keeping bot protection active for
other traffic.
